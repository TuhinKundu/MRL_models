'''
Adapted from https://raw.githubusercontent.com/huggingface/transformers/v4.37.2/examples/pytorch/text-classification/run_glue_no_trainer.py
'''
# coding=utf-8
...
def parse_args():
    ...
    parser.add_argument('--pretrained_weights', type=str, default=None, help="path for pretrained checkpoint file")
    parser.add_argument(
...
def main(args):
    ...
    # in the environment
    accelerator = (
        Accelerator(log_with=args.report_to, project_dir=args.output_dir, split_batches=True) if args.with_tracking else Accelerator(split_batches=True)
    )
    ...
    if args.resume_from_checkpoint:
        ...
        if "epoch" in training_difference:
            ...
            starting_epoch = resume_step // len_trainloader
            completed_steps = resume_step // args.gradient_accumulation_steps
            resume_step -= starting_epoch * len_trainloader
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(active_dataloader):
            ...
            if step % args.gradient_accumulation_steps == 0 or step == len_trainloader - 1:
                optimizer.step()
                lr_scheduler.step()
                optimizer.zero_grad()
            ...
            accelerator.log(
                {
                    ...
                    "train_loss": total_loss.item() / len_trainloader,
                    "epoch": epoch,
