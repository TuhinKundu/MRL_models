...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Whether dataset on disk is tokenized or not.",
    )
    parser.add_argument(
        "--dataset_config_name",
        type=str,
...
def main():
    ...
    if args.dataset_name is not None:
        ...
        if args.tokenized_dataset:
            ...
            raw_datasets = dataset.train_test_split(train_size=len(dataset) - int(0.1 * len(dataset)),
    ...
    if not args.tokenized_dataset:
        ...
        tokenized_datasets.save_to_disk(f'tokenized_{args.dataset_name}')
        train_dataset = tokenized_datasets["train"]
        eval_dataset = tokenized_datasets["validation"]
    else:
        train_dataset = load_from_disk(f'{args.dataset_name}/train/')
        eval_dataset = load_from_disk(f'{args.dataset_name}/test/')
