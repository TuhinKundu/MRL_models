'''
Adapted from https://github.com/mlfoundations/open_clip/blob/main/src/open_clip/model.py
'''
...
def _build_vision_tower(
    ...
    if vision_cfg.timm_model_name:
        ...
        norm_layer = LayerNormFp32 if cast_dtype in [torch.float16] else LayerNorm
